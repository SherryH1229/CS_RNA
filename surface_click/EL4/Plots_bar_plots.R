...
#sample_info <- read.csv("/home/xcao3/membraneRNA/pooledResult201901/cufflink_out/fpkmsWithClickNoDup.txt",sep="\t")
sample_info$EL4.Click.3 <- NULL
sample_info$EL4.Click.woCu <- NULL
...
FPKM_0 <- geneCount_FPKM(sample_info,14,18,0)
...
FPKM_5 <- geneCount_FPKM(sample_info,14,18,5)
...
FPKM_10 <- geneCount_FPKM(sample_info,14,18,10)
